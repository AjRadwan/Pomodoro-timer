...
function onPomodoroTimer(){
  ...
  gHours = 0;
   gMinutes = 25;  //change pomodoroTimer here
  gSeconds = 0;
  ...
  $('#pomodoroButton').addClass('btn-dark');
...
function onShortTimer(){
  ...
  gHours = 0;
  gMinutes = 5; //change short time here 
  gSeconds = 0;
...
function onLongTimer(){
  ...
  gHours = 0;
  gMinutes = 20; //change long break time here
  gSeconds = 0;
  ...
  $('#pomodoroButton').removeClass('btn-success');
  $('#shortButton').removeClass('btn-success');
  $('#longButton').addClass('btn-dark');
}

function onStartTimer(){

  $('#startButton').addClass('btn-dark');
